...
`;
	...
	const helpSubmenu: MenuItemConstructorOptions[] = [
		openUrlMenuItem({
			label: 'Website',
			url: 'https://www.broxme.com'
		}),
		
		openUrlMenuItem({
			label: 'Privacy',
			url: 'https://www.broxme.com/febbu/privacy'
		}),
	/**	{
	...
	if (!is.macos) {
		helpSubmenu.push(
			...
			aboutMenuItem({
				...
				text: 'Febbu by BroxMe Technology \n \n  Which based on open source project Caprine'
			})
		);
	}
